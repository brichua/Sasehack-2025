...
export default StyleSheet.create({
  ...
  filterButton: { flex:1, marginHorizontal:4, paddingVertical:8, borderRadius:10, alignItems:'center' },
  filterButtonActive: { backgroundColor: colors.viridian },
  ...
  input2: { backgroundColor: '#fff', padding: 10, borderRadius: 12, marginVertical: 6, color: colors.textDark },
  ...
  guildName: { color: colors.textMuted, fontSize:13, fontWeight:'600' },
  filterBar: { flexDirection:'row', justifyContent:'space-between', marginBottom:12 },
